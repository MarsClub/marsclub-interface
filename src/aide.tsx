    ...
    <span className={`relative inline-block align-middle ${className}`}>
      ...
      {ouvert && (
        <span
          id={id}
          role="tooltip"
          className="absolute left-0 top-5 z-20 w-72 rounded-lg border-2 border-sable bg-creme px-3 py-2 text-left text-xs font-normal normal-case tracking-normal text-charbon shadow-lg"
        >
          {texte}
        </span>
      )}
