...
export function EnTete({ badge, libelle, precedent, suivant, present, children, Lien = 'a', }) {
    return (_jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [badge && (_jsx("span", { className: "rounded-lg bg-charbon px-2.5 py-1 font-display text-lg font-semibold text-creme", children: badge })), _jsx("div", { className: "font-display text-2xl font-semibold", children: libelle }), (precedent || suivant) && (_jsxs("div", { className: "flex items-center gap-1", children: [precedent && (_jsx(Lien, { href: precedent, className: CLASSE_NAV, children: "\u2039" })), suivant && (_jsx(Lien, { href: suivant, className: CLASSE_NAV, children: "\u203A" })), present && (_jsx(Lien, { href: present.href, className: `ml-1 ${CLASSE_NAV} text-sm`, children: present.libelle }))] })), children] }));
}
