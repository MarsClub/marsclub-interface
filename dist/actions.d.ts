 ...
 */
export declare const CLASSE_ACQUIS_PETIT = "rounded bg-sable px-1.5 py-px text-xs font-semibold text-charbon";
export declare const CLASSE_EN_COURS_PETIT = "rounded border border-sable bg-transparent px-1.5 py-px text-xs font-semibold text-charbon";
